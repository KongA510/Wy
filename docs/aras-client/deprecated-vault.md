...
// 如需新建实例：
// var vault = new Aras.Client.Controls.Public.Vault();
```
...
```javascript
// 设置下载时的本地文件名
aras.vault.setLocalFileName('downloaded_report.pdf');
```
...
// 这些数据会以 multipart/form-data 格式随文件一起发送
```
