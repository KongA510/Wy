...
<tr><td>[获取系统物料分类](/integration/xj-get-class-structure)</td><td>XJ_GetClassStructure</td><td>/PLM/server/odata/method.XJ_GetClassStructure</td><td>多级物料分类树</td></tr>
<tr><td>[获取部位编码](/integration/xj-get-body-part-code)</td><td>XJ_GetBodyPartCode</td><td>/PLM/server/odata/method.XJ_GetBodyPartCode</td><td>部位编码键值对</td></tr>
<tr><td>[BOM 接口（入口）](/integration/xj-bom-interface)</td><td>XJ_BOMInterface</td><td>/PLM/server/odata/method.XJ_BOMInterface</td><td>BOM 明细新增/修改/删除</td></tr>
<tr><td>[BOM 核心服务](/integration/xj-bom-interface-server)</td><td>XJ_BOMInterfaceServer</td><td>（内部 Method，由入口委托）</td><td>批量 AML 核心逻辑</td></tr>
</tbody>
</table>
...
```text
http://10.1.1.158/PLM/server/odata/method.{方法名称}
