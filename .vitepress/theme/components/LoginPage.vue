  ...
  <div class="login-card">
    ...
    <form class="login-form" @submit.prevent="handleSubmit">
      <div class="form-group">
        ...
        <input v-model="username" type="text" class="form-input" placeholder="请输入账号" autocomplete="username" />
      </div>
      <div class="form-group">
...
.login-icon { font-size: 36px; display: block; margin-bottom: 12px; }
.login-title { font-size: 22px; font-weight: 700; color: #111827; margin: 0 0 6px; }
.login-subtitle { font-size: 14px; color: #9ca3af; margin: 0; }
...
.form-error { font-size: 13px; color: #ef4444; text-align: center; }
.login-btn {
  padding: 11px;
  background: #6366f1;
  color: #fff;
