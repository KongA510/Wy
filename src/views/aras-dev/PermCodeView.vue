<template>
  <article class="doc-content">
    ...
    <h2>一、标准模板</h2>
    <pre v-pre><code class="language-csharp">// ===== 权限提升标准模板 =====
...
finally
{
    ...
    <h2>二、命名空间引用</h2>
    <pre v-pre><code class="language-csharp">// 服务端 Method 中以下命名空间已自动引用：
// Aras.IOM
...
// 如果编译错误，手动添加：
using Aras.Server.Security;</code></pre>
    ...
    <pre v-pre><code class="language-csharp">// 辅助类 — 使用 using 模式简化
