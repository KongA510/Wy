<template>
  <article class="doc-content">
    ...
    <h2>二、事件执行流程</h2>
    <pre v-pre><code class="language-text">客户端发起 add 操作
       │
       ▼
  ┌─────────────┐
  ...
  └──────┬──────┘
    ...
    <pre v-pre><code class="language-csharp">// 假设这是绑定在 Part ItemType 的 onBeforeAdd 事件 Method
// this = 即将被创建的 Part 实例
...
return this;</code></pre>
    ...
    <h2>四、阻止操作的方法</h2>
    <pre v-pre><code class="language-csharp">// onBeforeDelete — 阻止删除已被引用的零件
