<template>
  <article class="doc-content">
    ...
    <h3>2.1 基础模板</h3>
    <pre v-pre><code class="language-csharp">// Method: IC_GetPartInfo
// 类型: server
...
var json = "{" +
    ...
    "}";
return inn.newResult(json);</code></pre>

    <h3>2.2 带权限提升的模板（推荐）</h3>
    <pre v-pre><code class="language-csharp">// 所有涉及 applySQL 或跨 Identity 操作的 Method 使用此模板
...
finally
{
    ...
    <pre v-pre><code class="language-csharp">// 前端传入 JSON，后端反序列化后批量操作
