<template>
  <article class="doc-content">
    ...
    <h2>二、公共 API</h2>
    <pre v-pre><code class="language-javascript">function cuiContextMenu(
  ...
  destroy(): void           // 销毁菜单
    ...
    <h3>3.1 单层菜单项</h3>
    <pre v-pre><code class="language-javascript">// 普通菜单项 — 没有子菜单
{
  "@type": "CommandBarMenu",
  ...
  "sort_order": "128"
    ...
    <h3>3.2 嵌套菜单项（父菜单）</h3>
    <pre v-pre><code class="language-javascript">// 父菜单项 — 有子菜单
{
  "@type": "CommandBarMenu",
  ...
  "data": [
    ...
    <h3>4.1 网格右键菜单</h3>
    <pre v-pre><code class="language-javascript">// Grid 右键菜单插件
const gridContextMenuPlugin = {
  init: async function() {
    ...
    <pre v-pre><code class="language-javascript">import { cuiContextMenu } from './cui/cuiContextMenu';
...
showCustomMenu(300, 200, {
  ...
  // 关闭菜单: destroy()
    ...
    <pre v-pre><code class="language-javascript">// 客户端 Method: initPopupItemInItemsGrid
// 根据选中状态动态显示/隐藏菜单项
