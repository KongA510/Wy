<template>
  <article class="doc-content">
    ...
    <h4>语法</h4>
    <pre v-pre><code class="language-javascript">Aras.Client.Controls.Public.TreeGridContainer = function();</code></pre>
    <h4>返回值</h4>
    <p><strong>TreeGridContainer</strong> — 新创建的 TreeGridContainer 实例。</p>
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">// 通过工厂方法创建控件
var treeGridContainer = clientControlsFactory.createControl("TreeGridContainer");</code></pre>
    ...
    <p>默认单元格背景色。</p>
    <h5>语法</h5>
    <pre v-pre><code class="language-javascript">function get_bgColor();
function set_bgColor(value);</code></pre>
    <h5>参数</h5>
    <table>
    ...
    <h5>语法</h5>
    <pre v-pre><code class="language-javascript">function get_bgInvert();
function set_bgInvert(value);</code></pre>
    <h5>参数</h5>
    <table>
      <thead><tr><th>参数</th><th>类型</th><th>说明</th></tr></thead>
    ...
    <p>返回值: <strong>string</strong></p>
    <h5>示例</h5>
    <pre v-pre><code class="language-javascript">// 获取默认行高
var height = treeGridContainer.rowHeight;

// 设置行高为 32 像素
treeGridContainer.rowHeight = "32";</code></pre>
    ...
    <h5>示例</h5>
    <pre v-pre><code class="language-javascript">function gridLinkClick(link) {
    console.log("链接被点击:", link);
}
clientControlsFactory.on(control, "gridLinkClick", gridLinkClick);</code></pre>
    ...
    <h5>示例</h5>
    <pre v-pre><code class="language-javascript">function gridMenuClick(menuItem, rowId, columnIndex) {
    if (menuItem === "删除") {
        treeGridContainer.deleteRow(rowId);
    }
}
clientControlsFactory.on(control, "gridMenuClick", gridMenuClick);</code></pre>
    ...
    <h5>示例</h5>
    <pre v-pre><code class="language-javascript">function gridMenuInit(rowId, columnIndex) {
    // 动态添加菜单项
...
clientControlsFactory.on(control, "gridMenuInit", gridMenuInit);</code></pre>
    ...
    <h5>示例</h5>
    <pre v-pre><code class="language-javascript">function gridClick(rowId, columnIndex) {
    console.log("行 " + rowId + " 的第 " + columnIndex + " 列被点击");
}
clientControlsFactory.on(control, "gridClick", gridClick);</code></pre>
    ...
    <h5>示例</h5>
    <pre v-pre><code class="language-javascript">function gridDoubleClick(rowId, columnIndex) {
    // 双击打开对应 Item
...
clientControlsFactory.on(control, "gridDoubleClick", gridDoubleClick);</code></pre>
    ...
    <h5>示例</h5>
    <pre v-pre><code class="language-javascript">function gridRowSelect(rowId, multi) {
    // 在行选中前执行自定义逻辑
    var isAllowed = myCustomValidation(rowId);
    return isAllowed; // 返回 false 可以阻止选中
}
clientControlsFactory.on(control, "gridRowSelect", gridRowSelect);</code></pre>
    ...
    <h5>示例</h5>
    <pre v-pre><code class="language-javascript">function gridXmlLoaded() {
    // XML 加载完成后执行初始化逻辑
    treeGridContainer.expandAll();
}
clientControlsFactory.on(control, "gridXmlLoaded", gridXmlLoaded);</code></pre>
    ...
    <h5>示例</h5>
    <pre v-pre><code class="language-javascript">// 从 XML 字符串初始化网格
...
treeGridContainer.initXML(bodyXml);</code></pre>
    ...
    <h5>示例</h5>
    <pre v-pre><code class="language-javascript">// 在根级添加一个新节点
treeGridContainer.insertRoot(
    ...
    <h5>示例</h5>
    <pre v-pre><code class="language-javascript">// 为选中行添加子节点
...
if (selectedId) {
    ...
    <h5>示例</h5>
    <pre v-pre><code class="language-javascript">// 单选模式选中一行
...
// 取消所有选中（使用不存在的 rowId）
treeGridContainer.setSelectedRow("", false, false);</code></pre>
    ...
    <h5>示例</h5>
    <pre v-pre><code class="language-javascript">// 展开指定节点
...
function addChildAndExpand(parentId, childId, cellsValues) {
    ...
    <h5>示例</h5>
    <pre v-pre><code class="language-javascript">// 读取单元格值
var value = treeGridContainer.getCellValue("item_001", 2);</code></pre>
    ...
    <h5>示例</h5>
    <pre v-pre><code class="language-javascript">// 批量更新选中行的单元格
...
for (var i = 0; i &lt; ids.length; i++) {
    ...
    <h5>示例</h5>
    <pre v-pre><code class="language-javascript">// 设置列为不可编辑
...
treeGridContainer.setColumnProperties(
    ...
    <p><strong>string</strong></p>
    <h5>示例</h5>
    <pre v-pre><code class="language-javascript">// 存储行级自定义数据
treeGridContainer.setUserData("item_001", "itemTypeName", "Part");

// 读取行级自定义数据
var itemType = treeGridContainer.getUserData("item_001", "itemTypeName");</code></pre>
    ...
    <h5>示例</h5>
    <pre v-pre><code class="language-javascript">// 批量操作时禁用重绘以提升性能
...
// 恢复重绘
treeGridContainer.setPaintEnabled(true);</code></pre>
    ...
    <h5>示例</h5>
    <pre v-pre><code class="language-javascript">treeGridContainer.setCellFont("item_001", 0, "Courier-bold-12");</code></pre>
    ...
    <h5>示例</h5>
    <pre v-pre><code class="language-javascript">// 为节点设置自定义图标
treeGridContainer.setRowIcons(
    ...
    <pre v-pre><code class="language-javascript">// 1. 通过工厂方法创建控件（在表单 HTML 内嵌时）
