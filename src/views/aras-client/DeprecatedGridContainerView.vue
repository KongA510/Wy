<template>
  <article class="doc-content">
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">// 通过 clientControlsFactory 创建 GridContainer
...
grid.showInputRow(true);</code></pre>
    ...
    <p>获取或设置单元格的默认背景颜色。</p>
    <h4>语法</h4>
    <pre v-pre><code class="language-javascript">// 获取
var color = grid.bgColor;
// 设置
grid.bgColor = "#FFFFFF";</code></pre>
    <h4>返回值</h4>
...
grid.bgInvert = true;</code></pre>
    ...
    <p>获取或设置单元格边框颜色。</p>
    <h4>语法</h4>
    <pre v-pre><code class="language-javascript">grid.borderGColor = "#CCCCCC";
var borderColor = grid.borderGColor;</code></pre>
    <h4>返回值</h4>
    <p><strong>bool</strong></p>
    ...
    <h4>语法</h4>
    <pre v-pre><code class="language-javascript">// 设置分隔符为逗号
grid.delimeter = ",";
var delim = grid.delimeter;</code></pre>
    <h4>返回值</h4>
    <p><strong>string</strong></p>
    ...
    <p>获取或设置表格的默认文本字体。</p>
    <h4>语法</h4>
    <pre v-pre><code class="language-javascript">grid.font = "Arial";
var currentFont = grid.font;</code></pre>
    <h4>返回值</h4>
    <p><strong>string</strong></p>
    ...
    <h4>语法</h4>
    <pre v-pre><code class="language-javascript">// 设置行高为 30 像素
grid.rowHeight = "30";
var height = grid.rowHeight;</code></pre>
    <h4>返回值</h4>
    <p><strong>string</strong></p>
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">clientControlsFactory.on(control, "gridLinkClick", function(link) {
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">clientControlsFactory.on(control, "gridMenuClick", function(menuItem, rowId, columnIndex) {
    if (menuItem === "删除") {
    ...
    <p><strong>bool</strong></p>
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">clientControlsFactory.on(control, "gridMenuInit", function(rowId, columnIndex) {
    grid.menuRemoveAll();
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">clientControlsFactory.on(control, "gridClick", function(rowId, columnIndex) {
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">clientControlsFactory.on(control, "gridDoubleClick", function(rowId, columnIndex) {
    // 双击打开编辑对话框
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">clientControlsFactory.on(control, "gridKeyPress", function(keyEvent) {
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">clientControlsFactory.on(control, "gridXmlLoaded", function() {
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">clientControlsFactory.on(control, "gridRowSelect", function(rowId, multi) {
    ...
    <p><strong>object</strong></p>
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">clientControlsFactory.on(control, "gridEditCell", function(type, rowId, columnIndex) {
    // 可以在编辑开始时动态设置下拉框选项
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">clientControlsFactory.on(control, "gridSelectCell", function(cell) {
    console.log("单元格被选中");
});</code></pre>
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">clientControlsFactory.on(control, "gridSort", function(columnIndex, asc, savedOrder) {
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">// 添加一行数据
grid.addRow("row_001", "值1\t值2\t值3");
// 或者使用分隔符
grid.delimeter = ",";
grid.addRow("row_002", "列1值,列2值,列3值");</code></pre>
    ...
    <p>删除表格中的所有行。</p>
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">// 清空表格
grid.removeAllRows();</code></pre>
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">// 将当前选中行上移
...
if (selectedId) {
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">// 获取值
var val = grid.getCellValue("row_001", 0);

// 设置值
grid.setCellValue("row_001", 1, "新值");</code></pre>
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">// 编辑第一行第二列的单元格
grid.editCell("row_001", 1);</code></pre>
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">// 在 gridEditCell 事件中动态设置下拉框
clientControlsFactory.on(control, "gridEditCell", function(type, rowId, columnIndex) {
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">grid.setCellFont("row_001", 0, "Courier-bold-12");
grid.setCellFont("row_002", 1, "Arial-italic-10");</code></pre>
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">// 设置第 0 列为不可编辑文本
...
// 设置第 3 列为可编辑文本框
grid.setColumnProperties("type=FIELD,sortable=yes,sorttype=string", 3);</code></pre>
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">// 按第 0 列升序排列
grid.sort(0, true);
// 按第 1 列降序排列
grid.sort(1, false);</code></pre>
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">// 单选模式
grid.setSelectedRow("row_001", false, true);

// 多选模式 - 取消所有选中行的技巧
grid.deselect();
grid.setSelectedRow("row_002", true, true);</code></pre>
    ...
    <h4>完整菜单示例</h4>
    <pre v-pre><code class="language-javascript">// 在 gridMenuInit 事件中构建动态右键菜单
...
clientControlsFactory.on(control, "gridMenuClick", function(menuItem, rowId, columnIndex) {
    ...
    <h4>XML 结构示例</h4>
    <pre v-pre><code class="language-xml">&lt;?xml version="1.0" encoding="UTF-8" standalone="yes"?&gt;
&lt;root lang="XML"&gt;
...
&lt;/root&gt;</code></pre>
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">// 存储 ItemType 信息
grid.setUserData("row_001", "itemType", "Part");
grid.setUserData("row_001", "isLocked", "false");

// 读取存储的数据
var itemType = grid.getUserData("row_001", "itemType"); // "Part"</code></pre>
...
grid.addColumnToDiffView("description");</code></pre>
    ...
    <p>禁用或启用整个表格。</p>
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">// 数据处理期间禁用表格
grid.disable();
// ... 批量更新数据 ...
grid.enable();</code></pre>
    ...
    <h3>初始化表格并绑定事件</h3>
    <pre v-pre><code class="language-javascript">// 1. 创建 GridContainer 控件
...
clientControlsFactory.on(grid, "gridXmlLoaded", function() {
    ...
    <h3>动态构建表格</h3>
    <pre v-pre><code class="language-javascript">// 通过 XML 字符串构建表格
...
grid.setColumnProperties("type=FIELD", 1);   // 描述列可编辑</code></pre>
