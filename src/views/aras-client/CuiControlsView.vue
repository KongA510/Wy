<template>
  <article class="doc-content">
    ...
    <pre v-pre><code class="language-javascript">import getControlMetadata from './cuiControls';
...
// }</code></pre>
    ...
    <h2>四、控件类型注册示例</h2>
    <pre v-pre><code class="language-javascript">// cuiControls.js — 控件类型注册中心
...
const controlRegistry = {
  ...
  'TocControl': {
    ...
    <pre v-pre><code class="language-text">CUI Layout.init()
  │
  ├─ 1. 获取 CUI 数据（含控件定义列表）
  ...
  │
  └─ 3. 所有控件就绪，布局进入运行状态</code></pre>

    <h2>六、自定义控件类型</h2>
    <pre v-pre><code class="language-javascript">// 1. 创建自定义控件的初始化函数
