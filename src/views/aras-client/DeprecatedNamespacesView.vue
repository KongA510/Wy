<template>
  <article class="doc-content">
    ...
    <table>
      ...
      <tbody>
        <tr>
          <td><router-link to="/aras-client/deprecated-cell"><code>Cell</code></router-link></td>
        ...
        <tr>
          <td><router-link to="/aras-client/deprecated-gridcontainer"><code>GridContainer</code></router-link></td>
          <td>网格控件容器，提供完整的 Grid 操作 API（行管理、列管理、事件、选择、排序等）。</td>
          <td>使用 <code>cuiGrid</code> / <code>cuiGridControl</code> 替代</td>
        </tr>
        <tr>
          <td><router-link to="/aras-client/deprecated-htmleditor"><code>HtmlEditor</code></router-link></td>
          <td>HTML 富文本编辑器控件，提供内容获取/设置、图片插入、启用/禁用等功能。</td>
          <td>使用标准 Web 富文本编辑器方案</td>
        </tr>
        <tr>
          <td><router-link to="/aras-client/deprecated-treegridcontainer"><code>TreeGridContainer</code></router-link></td>
          <td>"树形模式"下的网格容器，支持树状层级展示数据的 Grid。</td>
          <td>使用 <code>cuiTreeGrid</code> 替代</td>
        </tr>
        <tr>
          <td><router-link to="/aras-client/deprecated-toolbaritem"><code>ToolbarItem</code></router-link></td>
          <td>工具栏项对象，通过 <code>Toolbar.getItem()</code> 返回。</td>
          <td>使用 <code>cuiToolbar</code> / <code>aras-toolbar</code> 替代</td>
        </tr>
        <tr>
          <td><router-link to="/aras-client/deprecated-toolbar"><code>Toolbar</code></router-link></td>
          <td>工具栏控件容器。</td>
          <td>使用 <code>cuiToolbar</code> / <code>aras-toolbar</code> 替代</td>
        </tr>
        <tr>
          <td><router-link to="/aras-client/deprecated-vault"><code>Vault</code></router-link></td>
          <td>文件保险库（<code>aras.vault</code>），提供批量文件上传/下载和文件操作能力。</td>
          <td>使用新的文件管理 API</td>
        </tr>
        <tr>
          <td><router-link to="/aras-client/deprecated-utils"><code>Utils</code></router-link></td>
    ...
    <table>
      ...
      <tbody>
        <tr>
          <td><router-link to="/aras-client/deprecated-cmfstyle"><code>CmfStyle</code></router-link></td>
        ...
        <tr>
          <td><router-link to="/aras-client/deprecated-computeresult"><code>ComputeMethodResultBuilder</code></router-link></td>
        ...
        <tr>
          <td><router-link to="/aras-client/deprecated-element"><code>Element</code></router-link></td>
          <td>CMF 树中的一个节点。属性：id, parentId, boundItemId, type, name。</td>
          <td>使用 CUI 控件数据模型</td>
        </tr>
        <tr>
          <td><router-link to="/aras-client/deprecated-factory"><code>Factory</code></router-link></td>
          <td>"工厂方法"模式创建 CMF 类实例。提供 createMappingModel、createCmfStyle、findDescendantElements 方法。</td>
          <td>使用标准 JavaScript 构造函数</td>
        </tr>
        <tr>
          <td><router-link to="/aras-client/deprecated-propertyitem"><code>PropertyItem</code></router-link></td>
          <td>CMF 网格中的一个单元格。属性：id, value, type, cmfStyle。</td>
          <td>使用 <code>aras-grid</code> 单元格 API</td>
        </tr>
        <tr>
          <td><router-link to="/aras-client/deprecated-tree"><code>Tree</code></router-link></td>
          <td>在 CMF 文档树中搜索元素的类。方法：findElementWithBinding。</td>
          <td>使用 CUI 控件查找 API</td>
        </tr>
        <tr>
          <td><router-link to="/aras-client/deprecated-mappingmodel"><code>MappingModel</code></router-link></td>
