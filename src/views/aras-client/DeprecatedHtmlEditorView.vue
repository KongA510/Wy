<template>
  <article class="doc-content">
    ...
    <h4>签名</h4>
    <pre v-pre><code class="language-javascript">Aras.Client.Controls.Public.HtmlEditor = function();</code></pre>
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">// 通过 clientControlsFactory 创建 HtmlEditor 实例
const htmlEditor = clientControlsFactory.createControl(
  ...
  options
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">// 仅获取 body 内部内容（通常用于存储到数据库）
const bodyContent = htmlEditor.getHTMLSource(true);

// 获取完整 HTML 文档
const fullDocument = htmlEditor.getHTMLSource(false);</code></pre>
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">// 设置 body 内容（常用于从数据库加载内容后回填编辑器）
...
const fullContent = `&lt;html&gt;&lt;head&gt;&lt;/head&gt;&lt;body&gt;
  &lt;h2&gt;标题&lt;/h2&gt;&lt;p&gt;段落文本&lt;/p&gt;
&lt;/body&gt;&lt;/html&gt;`;
htmlEditor.setHTMLSource(false, fullContent);</code></pre>
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">// 插入一张左对齐、无边框、带 10px 间距的图片
...
htmlEditor.insertImage(
  ...
  5
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">// 根据权限控制编辑器状态
...
async function submitContent() {
  ...
  try {
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">// 旧方式（已弃用）
...
const htmlEditor = clientControlsFactory.createControl(
  ...
  options
    ...
    <h4>签名</h4>
    <pre v-pre><code class="language-javascript">clientControlsFactory.on(control, "onBlur", onBlurHandler);</code></pre>
    <h4>参数</h4>
    <table>
      <thead><tr><th>参数</th><th>类型</th><th>说明</th></tr></thead>
      <tbody>
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">// 绑定失去焦点事件
clientControlsFactory.on(htmlEditor, "onBlur", function() {
  ...
  autoSave(currentContent);
    ...
    <h4>签名</h4>
    <pre v-pre><code class="language-javascript">clientControlsFactory.on(control, "onChange", onChangeHandler);</code></pre>
    <h4>参数</h4>
    <table>
      <thead><tr><th>参数</th><th>类型</th><th>说明</th></tr></thead>
      <tbody>
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">// 监听内容变更，如实现脏标记
let isDirty = false;
...
function beforeClose() {
  ...
  return true;
    ...
    <h4>签名</h4>
    <pre v-pre><code class="language-javascript">clientControlsFactory.on(control, "onAfterPaste", onAfterPasteHandler);</code></pre>
    <h4>参数</h4>
    <table>
      <thead><tr><th>参数</th><th>类型</th><th>说明</th></tr></thead>
      <tbody>
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">// 粘贴后清理格式
...
function sanitizeHtml(html) {
  return html
    ...
    <pre v-pre><code class="language-javascript">// 1. 创建 HtmlEditor 实例
