<template>
  <article class="doc-content">
    ...
    <h3>3.1 构造函数</h3>
    <pre v-pre><code class="language-javascript">// 创建 Toolbar
const toolbar = document.createElement('aras-toolbar');
// 或
const toolbar = new Toolbar();

// 添加到 DOM
document.getElementById('toolbar-area').appendChild(toolbar);</code></pre>
    ...
    <h3>3.3 数据管理</h3>
    <pre v-pre><code class="language-javascript">// data — Map 对象，key 为元素标识符，value 为元素描述对象
...
console.log(btnSave.enabled);  // false</code></pre>

    <h3>3.4 容器布局</h3>
    <pre v-pre><code class="language-javascript">// container — 左侧容器（左对齐）
...
// 最终效果:
// [新建] [保存] | [删除]  ······空白区域······  [刷新]</code></pre>

    <h3>3.5 事件订阅</h3>
    <pre v-pre><code class="language-javascript">// 订阅工具栏事件
...
unsubscribe();</code></pre>
    ...
    <h3>自定义格式化器</h3>
    <pre v-pre><code class="language-javascript">// 注册自定义格式化器 — 搜索输入框
...
toolbar.data = new Map([
  ['search_box', {
    ...
    <h2>五、实际应用示例</h2>
    <pre v-pre><code class="language-javascript">// 完整的 ItemView 工具栏
