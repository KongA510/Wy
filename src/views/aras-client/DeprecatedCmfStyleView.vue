<template>
  <article class="doc-content">
    ...
    <h4>签名</h4>
    <pre v-pre><code class="language-javascript">Aras.Modules.CMF.Public.CmfStyle = function();</code></pre>
    <h4>参数</h4>
    <p><em>无参数。</em></p>
    <h4>返回值</h4>
    <p><strong>Aras.Modules.CMF.Public.CmfStyle</strong> — 新创建的 CmfStyle 实例。</p>
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">// 通过工厂方法创建 CmfStyle 实例（推荐方式）
var style = inArgs.factory.createCmfStyle();

// 不推荐直接使用 new 构造函数
// var style = new Aras.Modules.CMF.Public.CmfStyle();</code></pre>
    <hr />
    ...
    <h4>语法</h4>
    <pre v-pre><code class="language-javascript">function get_backgroundColor();
function set_backgroundColor(value);</code></pre>
    <h4>参数</h4>
    <table>
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">var style = inArgs.factory.createCmfStyle();
style.backgroundColor = '#BEBEBE';</code></pre>

    <h3>.textColor</h3>
    <p>获取或设置元素的文字颜色。仅支持 <code>"#aBcdeF"</code> 格式的十六进制颜色值，大小写不敏感。</p>
    <h4>语法</h4>
    <pre v-pre><code class="language-javascript">function get_textColor();
function set_textColor(value);</code></pre>
    <h4>参数</h4>
    <table>
      <thead><tr><th>参数</th><th>类型</th><th>说明</th></tr></thead>
      <tbody>
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">var style = inArgs.factory.createCmfStyle();
style.textColor = '#BEBEBE';</code></pre>

    <h4>颜色属性综合示例</h4>
    <pre v-pre><code class="language-javascript">// 在 CMF 方法中为元素设置配色主题
var computeMethod = function(inArgs) {
  ...
  return resultBuilder;
    ...
    <h4>语法</h4>
    <pre v-pre><code class="language-javascript">function get_fontFamily();
function set_fontFamily(value);</code></pre>
    <h4>参数</h4>
    <table>
      <thead><tr><th>参数</th><th>类型</th><th>说明</th></tr></thead>
      <tbody>
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">var style = inArgs.factory.createCmfStyle();
style.fontFamily = "Georgia, 'Times New Roman', Times, serif";</code></pre>

    <h3>.fontSize</h3>
    <p>获取或设置元素的字号。仅支持整数值（不支持小数），单位为像素（px）。</p>
    <h4>语法</h4>
    <pre v-pre><code class="language-javascript">function get_fontSize();
function set_fontSize(value);</code></pre>
    <h4>参数</h4>
    <table>
      <thead><tr><th>参数</th><th>类型</th><th>说明</th></tr></thead>
      <tbody>
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">var style = inArgs.factory.createCmfStyle();
style.fontSize = 12;</code></pre>

    <h3>.fontStyle</h3>
    <p>获取或设置元素的字体样式。仅支持 <code>"normal"</code> 和 <code>"italic"</code> 两个值。</p>
    <h4>语法</h4>
    <pre v-pre><code class="language-javascript">function get_fontStyle();
function set_fontStyle(value);</code></pre>
    <h4>参数</h4>
    <table>
      <thead><tr><th>参数</th><th>类型</th><th>说明</th></tr></thead>
      <tbody>
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">var style = inArgs.factory.createCmfStyle();
style.fontStyle = 'italic';</code></pre>

    <h3>.fontWeight</h3>
    <p>获取或设置元素的字体粗细。仅支持 <code>"normal"</code> 和 <code>"bold"</code> 两个值。</p>
    <h4>语法</h4>
    <pre v-pre><code class="language-javascript">function get_fontWeight();
function set_fontWeight(value);</code></pre>
    <h4>参数</h4>
    <table>
      <thead><tr><th>参数</th><th>类型</th><th>说明</th></tr></thead>
      <tbody>
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">var style = inArgs.factory.createCmfStyle();
style.fontWeight = 'bold';</code></pre>

    <h4>字体属性综合示例</h4>
    <pre v-pre><code class="language-javascript">// 为报表标题设置醒目的字体样式
var computeMethod = function(inArgs) {
  ...
  return element;
    ...
    <h4>语法</h4>
    <pre v-pre><code class="language-javascript">function get_textDecoration();
function set_textDecoration(value);</code></pre>
    <h4>参数</h4>
    <table>
      <thead><tr><th>参数</th><th>类型</th><th>说明</th></tr></thead>
      <tbody>
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">var style = inArgs.factory.createCmfStyle();
style.textDecoration = 'underline';</code></pre>

    <h3>.textAlign</h3>
    <p>获取或设置元素的文字水平对齐方式。仅支持 <code>"left"</code>、<code>"right"</code> 和 <code>"center"</code> 三个值。</p>
    <h4>语法</h4>
    <pre v-pre><code class="language-javascript">function get_textAlign();
function set_textAlign(value);</code></pre>
    <h4>参数</h4>
    <table>
      <thead><tr><th>参数</th><th>类型</th><th>说明</th></tr></thead>
      <tbody>
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">var style = inArgs.factory.createCmfStyle();
style.textAlign = 'right';</code></pre>

    <h4>对齐与装饰综合示例</h4>
    <pre v-pre><code class="language-javascript">// 创建带下划线的居中标题
var computeMethod = function(inArgs) {
...
var copy = style.clone();</code></pre>

    <h4>clone() 综合示例</h4>
    <pre v-pre><code class="language-javascript">// 使用 clone() 快速创建多个相似样式变体
var computeMethod = function(inArgs) {
  var resultBuilder = inArgs.factory.createComputeMethodResultBuilder();
  ...
  return resultBuilder;
    ...
    <pre v-pre><code class="language-javascript">// 完整的 CMF 方法示例 — 使用 CmfStyle 构建带样式的数据表格
var computeMethod = function(inArgs) {
  var resultBuilder = inArgs.factory.createComputeMethodResultBuilder();
