<template>
  <article class="doc-content">
    ...
    <h2>一、整体流程</h2>
    <pre v-pre><code class="language-text">开发自定义编辑器的四大步骤：
┌────────────────────────────────────────────┐
...
@section extra_header {
  ...
  <script src="../scripts/custom-editor.js"></script>
    ...
    <pre v-pre><code class="language-javascript">// OOTB ItemType 示例
...
class AppCustomEditorItemWindowView extends DefaultItemWindowView {
  getViewUrl() {
    ...
    <pre v-pre><code class="language-javascript">// 客户端 Method — OnShowItem 事件处理器
return window.ModulesManager.using([
  ...
  return creator.ShowView();
    ...
    <pre v-pre><code class="language-xml">&lt;!-- AML 方式创建 CUI 元素 --&gt;
&lt;AML&gt;
...
&lt;/AML&gt;</code></pre>
    ...
    <pre v-pre><code class="language-javascript">// BOMVisualEditorItemWindowView.js
