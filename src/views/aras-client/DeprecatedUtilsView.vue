<template>
  <article class="doc-content">
    ...
    <pre v-pre><code class="language-javascript">Aras.Client.Controls.Public.Utils = function();</code></pre>
...
aras.utils.setClipboardData(text);</code></pre>
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">// 安全地复制内容到剪贴板
...
// 使用示例
safeCopyToClipboard("P-000123");</code></pre>
    ...
    <h4>示例</h4>
    <pre v-pre><code class="language-javascript">// 在新 IE 窗口中打开一个 URL
