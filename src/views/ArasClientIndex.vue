<template>
  <div class="pm-index">
    <div class="page-header">
      <h1 class="page-title">Aras 客户端文档</h1>
      <p class="page-desc">Aras Innovator 客户端 JavaScript API 参考（ICS50 / std_14.37.0.44844-X），涵盖核心 API、CUI 可配置界面引擎、Web Components 组件库与可配置仪表板开发，共计 {{ totalDocs }} 篇</p>
    </div>

    <div class="category-grid">
      <div
        v-for="cat in arasClientMenu"
        :key="cat.id"
        class="category-card"
