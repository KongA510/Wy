<template>
  <article class="doc-content">
    ...
    <SourceDownload file="XJ_GetClassStructure.txt" href="/integration-source/XJ_GetClassStructure.txt" />
    ...
    <pre><code class="language-csharp">{{ parseCode }}</code></pre>

    <h3>4.3 分类节点数据结构</h3>
    <pre><code class="language-csharp">{{ nodeCode }}</code></pre>
...
const mainCode = `var itemType = inn.newItem("ItemType", "get");
...
const parseCode = `public static CategoryNode ParseClassNode(XmlNode node)
{
...
const nodeCode = `public class CategoryNode
{
