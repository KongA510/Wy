<template>
  <div class="aras-docs-index">
    <div class="page-header">
      <h1 class="page-title">Aras Innovator 文档中心</h1>
      <p class="page-desc">Aras Innovator 平台中文技术文档，涵盖核心概念、表单视图、工作流、权限管理等完整内容。共 {{ totalDocs }} 篇文档。</p>
    </div>

    <div class="category-grid">
      <div
        v-for="cat in arasDocMenu"
        :key="cat.id"
        class="category-card"
...
const totalDocs = computed(() => {
  ...
  arasDocMenu.forEach(count)
  return c
})

const iconMap: Record<string, string> = {
  '核心概念': '💡', '版本与文件管理': '📦', '表单与视图': '📋',
  '生命周期与工作流': '🔄', '权限与身份管理': '🔒', '搜索功能': '🔍',
  '国际化与本地化': '🌐', '界面与导航': '🖥️', '论坛与通知': '💬',
  '产品工程': '🏭', '项目管理': '📊', '其他功能': '⚙️',
}
...
<style scoped>
.aras-docs-index { max-width: 800px; }
