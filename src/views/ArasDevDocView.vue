    ...
    <div class="pm-doc-body">
      <div class="pm-doc-content">
        <div class="breadcrumb">
          ...
          <router-link to="/aras-dev" class="bc-link">Aras 开发笔记</router-link>
        ...
        <div v-else class="not-found">
          ...
          <h2>文档未找到</h2>
          <p>该文档尚未创建，请在 ArasDevDocView 中注册对应组件</p>
          <router-link to="/aras-dev" class="back-link">← 返回 Aras 开发笔记</router-link>
        </div>
...
// ── Doc Components ──
import IomOverviewView from './aras-dev/IomOverviewView.vue'
import InnovatorApiView from './aras-dev/InnovatorApiView.vue'
import ItemApiView from './aras-dev/ItemApiView.vue'
import BodyBuilderView from './aras-dev/BodyBuilderView.vue'
import MethodTypesView from './aras-dev/MethodTypesView.vue'
import ServerEventsView from './aras-dev/ServerEventsView.vue'
import CallMethodView from './aras-dev/CallMethodView.vue'
import AmlSyntaxView from './aras-dev/AmlSyntaxView.vue'
import AmlActionsView from './aras-dev/AmlActionsView.vue'
import AmlAdvancedView from './aras-dev/AmlAdvancedView.vue'
import PermModelView from './aras-dev/PermModelView.vue'
...
const docComponents: Record<string, any> = {
  'iom-overview': IomOverviewView,
  'innovator-api': InnovatorApiView,
  'item-api': ItemApiView,
  'body-builder': BodyBuilderView,
  'method-types': MethodTypesView,
  'server-events': ServerEventsView,
  'call-method': CallMethodView,
  'aml-syntax': AmlSyntaxView,
  'aml-actions': AmlActionsView,
  'aml-advanced': AmlAdvancedView,
  'perm-model': PermModelView,
