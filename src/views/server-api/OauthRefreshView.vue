<template>
  <article class="doc-content">
    ...
    <h2>一、类定义</h2>
    <pre v-pre><code class="language-csharp">// RefreshTokenProvider — 令牌刷新提供者
public class RefreshTokenProvider : ITokenProvider, ITokenProviderSession
{
    ...
    <pre v-pre><code class="language-csharp">public class RefreshTokenProviderOptions : TokenProviderOptions
{
