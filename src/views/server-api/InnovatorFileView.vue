<template>
  <article class="doc-content">
    ...
    <pre v-pre><code class="language-csharp">// 重载 1：指定 ID 和 UrlType
...
string thumbnailUrl = inn.getFileUrl(fileId, UrlType.Thumbnail);</code></pre>

    <h2>二、getFileUrls — 批量文件 URL</h2>
    <pre v-pre><code class="language-csharp">// 重载 1：ArrayList + UrlType
