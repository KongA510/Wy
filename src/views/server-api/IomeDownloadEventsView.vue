<template>
  <article class="doc-content">
    ...
    <h2>一、事件参数类</h2>
    <pre v-pre><code class="language-csharp">// DownloadFileCompletedEventArgs — 单文件下载完成
...
public class DownloadFilesProgressChangedEventArgs : EventArgs
{
    ...
    <pre v-pre><code class="language-csharp">// DownloadResult — 单个文件下载结果
public class DownloadResult
{
    ...
    <h2>三、事件委托</h2>
    <pre v-pre><code class="language-csharp">public delegate void DownloadFileCompletedEventHandler(
...
public delegate void DownloadFilesProgressChangedEventHandler(
    ...
    <pre v-pre><code class="language-csharp">public class CheckoutManager
{
    // 事件
