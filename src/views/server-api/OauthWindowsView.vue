<template>
  <article class="doc-content">
    ...
    <h2>一、类定义</h2>
    <pre v-pre><code class="language-csharp">// WindowsTokenProvider — Windows 集成认证令牌提供者
public class WindowsTokenProvider : ITokenProvider, ITokenProviderSession
{
    ...
    <pre v-pre><code class="language-csharp">// 极简配置 — 仅需 ServerUrl 和 Database
...
inn.Login(autoProvider);</code></pre>
