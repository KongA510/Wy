<template>
  <article class="doc-content">
    ...
    <pre v-pre><code class="language-csharp">// XPath 到 SOAP Fault 根节点（错误 Item 时）
...
// XPath 到顶层 &lt;Item&gt; 标签
public static string XPathResultItem</code></pre>
    ...
    <h2>六、各类形式的判断方法</h2>
    <pre v-pre><code class="language-csharp">// 判断 Item 的当前形式
...
if (item.isEmpty())       { /* dom 为空或仅含 Fault */ }</code></pre>
