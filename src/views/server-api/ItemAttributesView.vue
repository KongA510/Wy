<template>
  <article class="doc-content">
    ...
    <pre v-pre><code class="language-csharp">// getAttribute — 读取 Item 节点上的属性
...
item.removeAttribute("temporary_attr");</code></pre>

    <h2>二、Property Attribute 操作</h2>
    <pre v-pre><code class="language-csharp">// getPropertyAttribute — 读取属性子元素的 XML 属性
...
public void removePropertyAttribute(string propName, string attrName, string language)</code></pre>

    <h2>三、Action 和 Type 操作</h2>
    <pre v-pre><code class="language-csharp">// getAction / setAction — 操作类型
