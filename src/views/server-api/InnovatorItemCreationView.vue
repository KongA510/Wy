...
var result = part.apply("get");</code></pre>
...
var result = query.apply(); // 无需再指定 action</code></pre>
    <p><strong>参数：</strong></p>
    <table>
      <thead><tr><th>参数</th><th>说明</th></tr></thead>
      <tbody>
...
// 前端通过 result.getResult() 获取此文本</code></pre>
...
if (string.IsNullOrEmpty(name)) {
    ...
    <h2>六、完整示例：创建与查询</h2>
    <pre v-pre><code class="language-csharp">// 服务端 Method 中的典型操作
...
// 结果返回
return inn.newResult(extractedJsonString);</code></pre>
