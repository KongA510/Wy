...
copy.setProperty("item_number", "P-002"); // 不影响 original</code></pre>

    <h2>五、getInnovator / getParentItem</h2>
    <pre v-pre><code class="language-csharp">// getInnovator — 获取此 Item 所属的 Innovator 实例
public Innovator getInnovator()
var innovator = item.getInnovator();

// getParentItem — 获取父 Item
public Item getParentItem()
var parent = childItem.getParentItem();</code></pre>

    <h2>六、newXMLDocument / appendItem / removeItem</h2>
    <pre v-pre><code class="language-csharp">// newXMLDocument — 创建新 ArasXmlDocument
...
public int getItemCount()</code></pre>
...
var nodes = result.getItemsByXPath("//Item[@type='Part']");</code></pre>
